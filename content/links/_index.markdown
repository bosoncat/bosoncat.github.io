...
| [物含妙理总堪寻](http://blog.sciencenet.cn/u/jixuanhou) | 很有趣的老师，有很多科普文             | <span testURL="https://image-attachment.oss-cn-beijing.aliyuncs.com/data/www/html/uc_server/data/avatar/000/08/45/19_avatar_middle.jpg"> Testing </span> |
| [Matt Might](http://matt.might.net/)                       | Lots of interesting topics on PL       | <span testURL="https://matt.might.net/pics/Matt-Might-White-House-2-Jan-2015-small.jpg"> Testing </span> |
...
function testConnections() {
  ...
  for (let i = 0; i < links.length; i ++) {
    ...
    img.onerror = function() {
        links[i].innerHTML = '<i class="fas fa-circle" color="#ff0000"></i> Offline or insecure connection'
    };
...
function testConnections() {
  ...
  for (let i = 0; i < links.length; i ++) {
    ...
    img.style.display = "none";
    img.onload = function() {
        links[i].innerHTML = '<i class="fas fa-circle" color="#00ff00"></i> Secure connection'
    };
